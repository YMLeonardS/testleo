              ...
              <Navbar.Collapse className="collapse navbar-collapse" id="navbarSupportedContent-4">
                <div className="d-flex order-lg-2 align-items-center ms-auto">
                        ...
                        <div className="input-group">
                          <div className="input-group-btn search-panel">
                            <Form.Select className="select2">
                              <option label="All categories">All categories</option>
                  ...
                  <Dropdown className=" main-header-notification flag-dropdown">
                    <Dropdown.Toggle className="nav-link icon country-Flag " variant="default">
                    ...
                    <Dropdown.Menu className="dropdown-menu">
                      <Dropdown.Item className="d-flex ">
                        <span className="avatar  me-3 align-self-center bg-transparent">
                          <img src={frenchflag.src} alt="img" />
                        </span>
                      ...
                      <Dropdown.Item className="d-flex">
                        <span className="avatar  me-3 align-self-center bg-transparent">
                          <img src={germanyflag.src} alt="img" />
                        </span>
                        <div className="d-flex">
                      ...
                      <Dropdown.Item className="d-flex">
                        <span className="avatar me-3 align-self-center bg-transparent">
                          <img src={russiaflag.src} alt="img" />
                        </span>
                        <div className="d-flex">
                  ...
                  <Dropdown className=" main-header-notification">
                    ...
                    <Dropdown.Menu style={{ margin: 0 }}>
                      ...
                      <div className="dropdown-footer">
                        <Link href={`/components/advancedui/chat`}>View All Notifications</Link>
                      </div>
                    </Dropdown.Menu>
                  </Dropdown>
                  <div className="main-header-notification">
                    <Link href={`/components/advancedui/chat`} className="icon nav-link">
                  ...
                  <Dropdown className="main-profile-menu">
                    ...
                    <Dropdown.Menu style={{ margin: '0px' }}>
                      ...
                      <Dropdown.Item className="border-top" href={`${process.env.PUBLIC_URL}/pages/profile`}>
